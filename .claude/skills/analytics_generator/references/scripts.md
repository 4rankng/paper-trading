...
## Signal Aggregation Scripts (NEW)
...
**Usage:**
```bash
# Single ticker - creates {TICKER}_signal_summary.md in analytics folder
...
**Output:** `{TICKER}_signal_summary.md` in `analytics/{TICKER}/` folder
...
**Purpose:** LLM reads this auto-generated markdown to quickly understand technical position without parsing 40+ individual indicators.
...
**Files:**
- `{TICKER}_signal_summary.md` - **Auto-generated** technical scoring (created by aggregate_signals.py)
...
**Note:** `signal_summary.md` is auto-generated by script. Other files are created by LLM analysis.
...
# - analytics/TCOM/TCOM_signal_summary.md (auto-generated)
...
# 2. Generate latest technical, signal summary, and fundamental data
